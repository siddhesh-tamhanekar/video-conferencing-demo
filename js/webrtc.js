...
var localVideoElem = null,
  ...
  endCallButton = null;
  var peerConn = null;
  window.wsc = io('http://127.0.0.1:3000'),
  ...
  peerConn.createOffer(
    function (offer) {
      ...
      peerConn.setLocalDescription(new RTCSessionDescription(off),
        function() {
          wsc.emit("video",JSON.stringify({"sdp": off }));
        },
        function(error) { console.log(error);}
      );
    },
  ...
  peerConn.createAnswer(
    function (answer) {
      ...
      peerConn.setLocalDescription(ans, function() {
          wsc.emit("video",JSON.stringify({"sdp": ans }));
        },
        function (error) { console.log(error);}
      );
    },
...
function onIceCandidateHandler(evt) {
  ...
  wsc.emit("video",JSON.stringify({"candidate": evt.candidate }));
};
